...
export default function SearchBlock(){
    return(
        <>
            ...
            <div className="search-phone-size" style={{backgroundImage:"url(/image/searchbackground-phone-size.png)"}}>
                <div className="search-content text-color-main">
                    <div>量身訂做</div>
                    <div>找到最適合你的課程。</div>
                    <Input className="search-content-input" size="large" prefix={<img style={{width:'14.62px',height:'14.62px'}} src="/image/searchbtn.png"/>} placeholder="找課程?"></Input>
                </div>
            </div>
        </>
    )
